...
//        util.showBannerAd(getActivity());
//        util.showBannerAd2(getActivity());
    ...
    public class StickerAdapter extends RecyclerView.Adapter<StickerAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            Glide.with(getActivity()).load(stickerList[position]).thumbnail(0.5f).crossFade().diskCacheStrategy(DiskCacheStrategy.ALL).into(holder.imgSticker);
        }
